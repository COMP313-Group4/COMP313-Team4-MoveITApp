...
public class DriverLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvResetPassword=(TextView) findViewById(R.id.tv_driverResetPassword);
                ...
                firebaseAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            Intent intent = new Intent(DriverLoginActivity.this, DriverFeedActivity.class);
                            ...
                            Toast.makeText(DriverLoginActivity.this, "Error: invalid email and/or password ", Toast.LENGTH_LONG).show();
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        firebaseAuth.sendPasswordResetEmail(email).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DriverLoginActivity.this, "Password Reset Link sent to your email . . . ", Toast.LENGTH_LONG).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(DriverLoginActivity.this, "Error: Reset Link not sent ! "+e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
